//NOTA: Tratar de hacer 'Display questions' solo. (tiempo: 80 minutos) y si la cosa va bien seguir solo...
//Sino, copiar el codigo...
//Luego releer el resto de los features y aplicar el mismo procedimiento que el anterior

//data declarations
var questionID, question, choiceA, choiceB, choiceC, choiceD, questions, numQuestions, qInfo,
current = 0;
let sample = function([a , b , c , d]){
    console.log(a);
}
sample('dogo');
